...
import { ExternalLink, Users, Globe, Check, ChevronRight } from 'lucide-react'
...
export default function GameDetailPage() {
  ...
  // Get locale-specific descriptions
  ...
  const getLongDescription = () => {
    switch (locale) {
      case 'ua': return game.long_description_ua || game.long_description
      case 'ru': return game.long_description_ru || game.long_description
      default: return game.long_description
    }
  }
            ...
            <div className="flex-grow">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
                  ...
                  <div>
                     <p className="text-xs text-white/60 font-mono">{t('dau')}</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
                  ...
                  <div>
                    <p className="text-xs text-white/60 font-mono">{t('blockchain')}</p>
                ...
                <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/10 col-span-2 md:col-span-1">
                  ...
                  <div className="flex-grow min-w-0">
                    <p className="text-xs text-white/60 font-mono">{t('platforms')}</p>
